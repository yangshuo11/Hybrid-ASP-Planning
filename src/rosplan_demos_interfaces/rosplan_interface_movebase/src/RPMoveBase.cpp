...
namespace KCL_rosplan {
    ...
    RPMoveBase::RPMoveBase(std::string &actionserver) : action_client_(actionserver, true) {
        ...
        get_obs_client_ = nh.serviceClient<rosplan_interface_movebase::DetectImage>("/check_landmark");
    }
...
//                rosplan_interface_movebase::DetectImage detect_image_srv;
//                if (get_obs_client_.call(detect_image_srv)){
//                    ROS_INFO("detect_result: %d", detect_image_srv.response.result);
//                } else {
//                    ROS_INFO("Failed to call detect image service");
//                    ROS_INFO("start to plan an adaptive sensing behavior");
//                }
//                if (detect_image_srv.response.result == 1) {
//                    return true;
//                } else {
//                    return false;
//                }
