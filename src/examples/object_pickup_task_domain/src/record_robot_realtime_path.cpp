...
void model_state_callback(const gazebo_msgs::ModelStatesConstPtr &msg)
{
    ...
    robot_pose_file.open("trial_30_tiago_path.txt", ios::app);
    robot_pose_x.open("trial_30_tiago_path_x.txt", ios::app);
    robot_pose_y.open("trial_30_tiago_path_y.txt", ios::app);
