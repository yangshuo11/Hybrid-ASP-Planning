...
#include <rosoclingo/ROSoClingoAction.h>
...
namespace KCL_rosplan
{
	...
	private:
        ...
        actionlib::SimpleActionClient<rosoclingo::ROSoClingoAction> rosoclingo_action_client_;


    public:

		/* constructor */
		explicit EsterelPlanDispatcher(ros::NodeHandle& nh, std::string &actionserver);
