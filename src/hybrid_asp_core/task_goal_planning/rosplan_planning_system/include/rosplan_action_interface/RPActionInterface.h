...
namespace KCL_rosplan {
	...
	protected:
		...
		/* subscribe to sensor detection result */
		ros::ServiceClient aruco_detect_client_;
		bool aruco_detected;
    ...
    public:
        ...
        void arucoDetectionResultCallback(const geometry_msgs::PoseStamped::ConstPtr& msg);
