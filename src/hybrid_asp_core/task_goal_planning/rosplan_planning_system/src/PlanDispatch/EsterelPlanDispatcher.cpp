...
namespace KCL_rosplan {
    ...
    EsterelPlanDispatcher::EsterelPlanDispatcher(ros::NodeHandle& nh, std::string &actionserver): display_edge_type_(false),
        PlanDispatcher(nh), rosoclingo_action_client_(actionserver, true){
    ...
    int main(int argc, char **argv) {
        ...
        nh.param("action_server", actionserver, std::string("/rosoclingo"));

        KCL_rosplan::EsterelPlanDispatcher epd(nh, actionserver);
